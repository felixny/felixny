...
**[Evenmint](https://evenmint.vercel.app)** — Full-stack shared expense app with PostgreSQL-backed settlement logic, role-based access, and atomic month-close operations. Built with React, TypeScript, and Supabase. Live in production.

**[PulsePoint Android Template](https://github.com/felixny)** — Multi-module Android template with Jetpack Compose, MVI architecture, Flow-based state handling, Canvas components, and device-facing integration boundaries.
